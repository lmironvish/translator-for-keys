<template>
    <div class="user-trainings-participants-table">
        <button-block
        ...
        <sorting-block
            class="user-trainings-participants-table__sorting"
            :sortingList="tables[0].sortingList"
            @updateSorting="updateSorting($event, 0)"
            @openFilter="openFilter"
        />
        <filter-list
            class="user-trainings-participants-table__filter"
        ...
        />
        <table-block
            class="user-trainings-participants-table__table"
        ...
        <table-pagination
            ...
            class="user-trainings-participants-table__table-pagination"
        ...
        tables: [
            {
                ...
                api: api.kpi.trainingsParticipantsTable
            }
        ]
    }),
    created() {
...
<style src="./user-trainings-participants-table.less" lang="less" />
